...
def main():
    ...
    if model_args.model_run_name is not None:
        model_args.model_name_or_path = os.path.join(
            './models', model_args.model_run_name)
        training_args.output_dir = os.path.join(
            training_args.output_dir, model_args.model_run_name)
...
def run_mrc(
    ...
    def post_processing_function(
        ...
        predictions = postprocess_qa_predictions(
            ...
            prefix=model_args.model_run_name if model_args.model_run_name is not None else None,
        )
